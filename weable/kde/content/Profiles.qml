...
Rectangle {
    ...
    property string currentItem: "venus"
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            Image {
                ...
                width: 20
                height: 20
                source: "qrc:/quick/content/assets/material/symbols/web/book_2/book_2_48px.svg"
        ...
        Rectangle {
            ...
            Image {
                ...
                width: 20
                height: 20
                source: "qrc:/quick/content/assets/material/symbols/web/imagesmode/imagesmode_48px.svg"
            }
        }
