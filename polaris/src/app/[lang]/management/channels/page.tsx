...
export default async function ManagementChannelsPage({params, searchParams}: {
    ...
    const selectData = await ManagementChannelService.queryChannels(
        internalStargateUrl,
            ...
            <div className={pageStyles.pageContainer}>
                ...
                <div className={pageStyles.paginationBar}>
                    <PaginationServer
                        ...
                        pageLinkFunc={(p) =>
                            `/${lang}/management/channels` + replaceSearchParams(searchValue, 'page', p.toString())}
                    />
                </div>
            </div>
        </div>
