...
void polaris::base::SqliteRow::appendColumn(const polaris::base::SqliteColumn &&column)
{
    columnValues[column.getColIndex()] = column;
    colNames.push_back(column.getColName());
}

std::optional<polaris::base::SqliteColumn> polaris::base::SqliteRow::getColumn(const std::string &&colName)
{
...
std::optional<polaris::base::SqliteColumn> polaris::base::SqliteRow::getColumn(int colIndex)
{
