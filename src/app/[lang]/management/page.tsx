...
export default async function Page({params, searchParams}: {
    ...
    return <ManagementLayout lang={lang} pathname={pathname} searchParams={searchParamsValue}
        ...
        <div className={pageStyles.communityPage}>
            ...
            <div className={pageStyles.libGrid}>
                <div className={pageStyles.libHeader}>
                    ...
                    <a href={`/${lang}/management/channels`} className={pageStyles.libLink}>全部频道</a>
                </div>
            ...
            <div className={pageStyles.libGrid}>
                <div className={pageStyles.libHeader}>
                    ...
                    <a href={`/${lang}/management/articles`} className={pageStyles.libLink}>全部笔记</a>
                </div>
                <div className={pageStyles.libBody}>
                    <div className={pageStyles.libCard}>
                        <Monitor size={20}/>
