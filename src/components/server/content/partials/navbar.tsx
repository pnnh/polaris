...
export async function ContentPublicNavbar({pathname, lang, userInfo}: {
    pathname: string,
    lang: string,
    ...
    return <div className={styles.navHeader}>
        <div className={styles.leftNav}>
            <a className={styles.brandLink} href={`/`}>
                <img src='/images/logo.png' alt='logo' sizes={'48px,48px'}/>
            </a>
            <SiteNavMenu lang={lang} pathname={pathname}/>
        </div>
        <div className={styles.rightNav}>
            <ContentSearchAction pathname={pathname} queryKeyword={'todo'} lang={lang}/>
